...
|---|---|---|---|
| D1 | value-head convention (derived from the shipped capstone code) | 18 | OPEN |
| D2 | watch-nano-muzero-learn: live in-browser training vs labeled recording | 26 | OPEN |
